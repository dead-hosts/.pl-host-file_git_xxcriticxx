...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of .pl-host-file"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of .pl-host-file"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/.pl-host-file_git_xxcriticxx/'
